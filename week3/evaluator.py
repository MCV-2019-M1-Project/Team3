...
from feature_extractor import compute_feature_vector
...
if __name__ == '__main__':
    ...
    print(test_1_1.root)
    print(eval_set(test_1_1, gt_1_1, bbdd_matrix, opt))
    ...
    print(test_1_3.root)
    print(eval_set(test_1_3, gt_1_3, bbdd_matrix, opt))

    print(test_2_3.root)
    print(eval_set(test_2_3, gt_2_3, bbdd_matrix, opt))
